    ...
    return (
        <Layout>
            <div className='pt-16 px-8 overflow-x-hidden'>
                ...
                <div style={{ backgroundImage: `url(${grid})`, height: '80vh', minHeight: '400px', backgroundSize: '2000px' }} className='text-center bg-center min-h-80 flex flex-col justify-center items-center animate-in fade-in transition duration-700'>
